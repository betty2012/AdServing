 ...
 */
package de.marx_labs.ads.controller.servlets;
		...
		ctx.start(new Runnable() {
			public void run() {
				...
				try {
					...
					status_db.put("persistent_ad_count", RuntimeContext.getPersistentAds().size());
					status_db.put("distributed_ad_count", RuntimeContext.getDistributedAds().size());
