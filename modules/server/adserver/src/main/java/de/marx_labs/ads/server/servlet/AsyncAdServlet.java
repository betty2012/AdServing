...
public abstract class AsyncAdServlet extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request,
		...
		execute(ctx, AdContextListener.ADCONTEXT.get(), request, response);

	}

	protected abstract void execute(final AsyncContext ctx, final AdContext adcontext, HttpServletRequest request,
